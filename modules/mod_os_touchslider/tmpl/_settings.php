...
?>
            ...
            <div class="option-block pagination-block oss-pro-avaible">
              ...
              <span class="option">
                <div class="checkbox-block">
                  ...
                  <input id="paginationType2-<?php echo $module->id?>" class="paginationType hard-reset" name="paginationType<?php echo $module->id?>" type="radio" value="progressbar" <?php echo ($params->get('paginationType', 'bullets') == "progressbar")?'checked':''?>>
                    ...
                    <label class="checken" for="paginationType2-<?php echo $module->id?>" data-value="progressbar">Progress</label>
                  </div>
              </span>
            </div>
          </div>

          <div id="pagination-lickable-block-<?php echo $module->id?>" <?php echo ($params->get('paginationType', 'bullets') =='bullets'?'':'style="display:none;"'); ?> >
            <div class="option-block oss-pro-avaible">
  ...
  <!-- end -->              
    ...
    <div class="copyright-block">
      <a href="//ordasoft.com/os-touch-slider-joomla-slideshow-module" class="copyright-link" style="float:left;" title="Touch Slider - Joomla slideshow module">&copy;<?php echo date('Y'); ?> OrdaSoft.com All rights reserved. </a>
...
?>
        ...
        pagination: {
          el :                        '#os-slider-<?php echo $module->id;?> .swiper-pagination',
          type  :                     '<?php echo $params->get("paginationType","bullets");?>',
          clickable  :                <?php echo $params->get("paginationClickable", 1);?>,
        },
