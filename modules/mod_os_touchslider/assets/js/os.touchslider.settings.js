...
//          jQuerOs("#os-slider-"+oss.params.moduleId+".swiper-container").attr("style","width:"+width+"height:"+height); need recheck
    ...
    oss.resetSlider = function (reinit){
      ...
      if(jQuerOs("#paginationCont-" + oss.params.moduleId).prop("checked") ){
        ...
        jQuerOs("#os-slider-"+oss.params.moduleId+"  .swiper-pagination" + 
            ",#tab-content4-"+oss.params.moduleId+" .pagination-block").show('slow');

        if( jQuerOs(container + " .paginationType:checked").val() == 'bullets' ){
          jQuerOs("#pagination-lickable-block-" + oss.params.moduleId ).show('slow');
        }
      }else{
        jQuerOs("#pagination-lickable-block-" + oss.params.moduleId + 
          ",#os-slider-"+oss.params.moduleId+"  .swiper-pagination" + 
          ",#tab-content4-"+oss.params.moduleId+" .pagination-block").hide('slow');
      }
    ...
    oss.resetSliderSettings = function (){
      ...
      params.pagination.type = 'bullets';
      jQuerOs("#paginationType-" + oss.params.moduleId).prop("checked", true);
      params.pagination.clickable = false;
      ...
      if(parseInt(jQuerOs(container + " .pagination:checked").val()) &&
       jQuerOs(container + " .paginationType:checked").val() != 'progressbar'){
        jQuerOs("#pagination-lickable-block-" + oss.params.moduleId +
         ",#os-slider-"+oss.params.moduleId+"  .swiper-pagination").show('slow');
      }else{
        jQuerOs("#pagination-lickable-block-" + oss.params.moduleId + 
          ",#os-slider-"+oss.params.moduleId+"  .swiper-pagination").hide('slow');
      }
